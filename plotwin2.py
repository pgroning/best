...
class AppForm(QMainWindow):
    ...
    def create_main_frame(self):
        ...
        #
        self.dpi = 100
        self.fig = Figure((6.0, 4.8), dpi=self.dpi)
    ...
    def create_menu(self):        
        ...
        kinf = self.create_action("Kinf", slot=self.plot_kinf, tip="K-inf vs burnup")
        fint = self.create_action("Fint", slot=self.plot_fint, tip="Fint vs burnup")
        btf = self.create_action("BTF",tip="BTF vs burnup")
        
        self.add_actions(self.plot_menu, (kinf, fint, btf))
